...
class PurePursuitLineFollower(DrivingAlgorithm):
    ...
    def __init__(self, perception, planner, controller):
        ...
        purePursuitConfig = functions.openConfigFile('drivingAlgorithms/controllers/'+conf.controllerConfig)

        self.steeringControl = pathTracker.purePursuit(purePursuitConfig)
